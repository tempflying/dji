...
#include "../../QtTest/DJI_LIB/DJI_Pro_Hw.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DJI_Pro_Hw_t, stringdata) + ofs \
...
const QMetaObject DJI_Pro_Hw::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_DJI_Pro_Hw.data,
      qt_meta_data_DJI_Pro_Hw,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DJI_Pro_Hw.stringdata))
